...
public class Locação {
    ...
    public Locação(Integer locacaoId, BigDecimal qtdLocacao, LocalDate dataLocacao, LocalDate dataDevolucaoPrevista, LocalDate dataDevolucao, Boolean statusLocacao, String obsLocacao) {
